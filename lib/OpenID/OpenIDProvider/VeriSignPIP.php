 ...
 */
class OpenID_OpenIDProvider_VeriSignPIP extends OpenID_OpenIDProvider_AbstractProvider
{
    /**
    ...
    {
        return $this->__('Symantec Personal Identity Portal');
    }
