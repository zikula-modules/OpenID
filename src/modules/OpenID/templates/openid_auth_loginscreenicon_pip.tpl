<form id="users_loginscreen_loginwith_PIP" class="users_loginscreen_loginwith_button" method="post" action="{modurl modname='Users' type='user' func='loginScreen'}" enctype="application/x-www-form-urlencoded">
    <div>
